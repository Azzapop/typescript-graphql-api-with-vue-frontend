...
export type GqlGetPaintersQuery = { __typename?: 'Query', painters: Array<{ __typename?: 'Painter', name: string, country: string }> };
...
export type GqlMutationResolvers<ContextType = any, ParentType extends GqlResolversParentTypes['Mutation'] = GqlResolversParentTypes['Mutation']> = {
  createPainter: Resolver<Maybe<GqlResolversTypes['Painter']>, ParentType, ContextType, RequireFields<GqlMutationCreatePainterArgs, 'input'>>;
  createPainting: Resolver<Maybe<GqlResolversTypes['Painting']>, ParentType, ContextType, RequireFields<GqlMutationCreatePaintingArgs, 'input'>>;
};

export type GqlPainterResolvers<ContextType = any, ParentType extends GqlResolversParentTypes['Painter'] = GqlResolversParentTypes['Painter']> = {
  country: Resolver<GqlResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<GqlResolversTypes['String'], ParentType, ContextType>;
  name: Resolver<GqlResolversTypes['String'], ParentType, ContextType>;
  techniques: Resolver<Array<GqlResolversTypes['Technique']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type GqlPaintingResolvers<ContextType = any, ParentType extends GqlResolversParentTypes['Painting'] = GqlResolversParentTypes['Painting']> = {
...
export type GqlQueryResolvers<ContextType = any, ParentType extends GqlResolversParentTypes['Query'] = GqlResolversParentTypes['Query']> = {
  painter: Resolver<Maybe<GqlResolversTypes['Painter']>, ParentType, ContextType, RequireFields<GqlQueryPainterArgs, 'id'>>;
  painters: Resolver<Array<GqlResolversTypes['Painter']>, ParentType, ContextType>;
  painting: Resolver<Maybe<GqlResolversTypes['Painting']>, ParentType, ContextType, RequireFields<GqlQueryPaintingArgs, 'id'>>;
  paintings: Resolver<Array<GqlResolversTypes['Painting']>, ParentType, ContextType>;
};

export type GqlTechniqueResolvers<ContextType = any, ParentType extends GqlResolversParentTypes['Technique'] = GqlResolversParentTypes['Technique']> = {
  id: Resolver<GqlResolversTypes['String'], ParentType, ContextType>;
  name: Resolver<GqlResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
